                            ...
                            Rectangle {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { 
                                        Layout.alignment: Qt.AlignHCenter
                                        text: modelData.time
                                        font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: Math.round(12 * window.sf)
                                    ...
                                    Text { 
                                        ...
                                        font.family: "SF Pro Text"; font.weight: Font.Black; font.pixelSize: Math.round(14 * window.sf)
