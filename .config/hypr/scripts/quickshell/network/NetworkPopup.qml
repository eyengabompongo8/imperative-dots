                    ...
                    delegate: Item {
                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                Text { Layout.alignment: Qt.AlignHCenter; font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: window.s(14); color: window.overlay0; text: window.currentPowerPending ? (window.expectedEthPower === "on" ? "Powering On..." : "Powering Off...") : "Disconnected" }
                            }
                            ...
                            Item {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { 
                                        ...
                                        font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: window.s(13)
                                    ...
                                    Rectangle {
                                        ...
                                        TextInput {
                                            ...
                                            font.family: "SF Pro Text"; font.pixelSize: window.s(13); color: window.text
                            ...
                            Item {
                                ...
                                ColumnLayout {
                                    ...
                                    Text {
                                        ...
                                        font.family: "SF Pro Text"; font.weight: Font.Black
                                    ...
                                    Text {
                                        Layout.alignment: Qt.AlignHCenter
                                        font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: window.s(11)
                                        ...
                                        ColumnLayout {
                                            ...
                                            Item {
                                                ...
                                                Text {
                                                    ...
                                                    anchors.verticalCenter: parent.verticalCenter
                                                    text: floatCard.itemName
                                                    font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: window.s(13); color: window.crust 
                                                }
                                                Text { 
                                            ...
                                            Text {
                                                font.family: "SF Pro Text"; font.pixelSize: window.s(10); color: window.crust
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text { font.family: "SF Pro Text"; font.weight: Font.Black; font.pixelSize: window.s(13); color: window.activeMode === "eth" ? window.crust : window.text; text: "Ethernet"; Behavior on color { ColorAnimation{duration:200} } }
                        }
                        MouseArea {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text { font.family: "SF Pro Text"; font.weight: Font.Black; font.pixelSize: window.s(13); color: window.activeMode === "wifi" ? window.crust : window.text; text: "Wi-Fi"; Behavior on color { ColorAnimation{duration:200} } }
                        }
                        MouseArea {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text { font.family: "SF Pro Text"; font.weight: Font.Black; font.pixelSize: window.s(13); color: window.activeMode === "bt" ? window.crust : window.text; text: "Bluetooth"; Behavior on color { ColorAnimation{duration:200} } }
                        }
                        MouseArea {
