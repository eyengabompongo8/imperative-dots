                                        ...
                                        Repeater {
                                            ...
                                            Rectangle {
                                                ...
                                                RowLayout {
                                                    ...
                                                    Text {
                                                        text: modelData; font.family: "SF Pro Text"; font.weight: Font.Medium; font.pixelSize: root.s(11)
                                                        color: chipMa.containsMouse ? root.red : (box3.isActive ? root.base : root.text)
                                                        Behavior on color { ColorAnimation { duration: 150 } }
                                                    }
                                                    Text {
                                                        text: "✖"; font.family: "SF Pro Text"; font.pixelSize: root.s(11)
                                ...
                                ListView {
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        RowLayout {
                                            ...
                                            Text { text: model.code; font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: root.s(11); color: box3.isActive ? root.base : root.text; Behavior on color { ColorAnimation { duration: 150 } } }
                                        ...
                                        ListView {
                                            ...
                                            delegate: Rectangle {
                                                ...
                                                Text {
                                                    ...
                                                    text: model.path; font.family: "SF Pro Text"; font.pixelSize: root.s(10)
                            ...
                            Rectangle {
                                ...
                                RowLayout {
                                    ...
                                    TextInput { 
                                        ...
                                        verticalAlignment: TextInput.AlignVCenter
                                        font.family: "SF Pro Text"; font.pixelSize: root.s(12)
                                ...
                                Repeater {
                                    ...
                                    Rectangle {
                                        ...
                                        Text {
                                            ...
                                            font.family: "SF Pro Text"; font.pixelSize: root.s(10); font.capitalization: Font.Capitalize
                                            color: isSelected
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            anchors.top: parent.top; anchors.left: parent.left; anchors.right: parent.right; anchors.margins: root.s(16)
                            spacing: root.s(10)
                            Text { text: "Workspaces (SUPER + 1-9)"; font.family: "SF Pro Text"; font.weight: Font.Medium; font.pixelSize: root.s(12); color: root.text; Layout.alignment: Qt.AlignVCenter }
                            Flow {
                            ...
                            ColumnLayout {
                                ...
                                Item {
                                    ...
                                    Row {
                                        ...
                                        Text {
                                            text: "+"; font.family: "SF Pro Text"; font.pixelSize: root.s(10)
                                            color: root.overlay0
                                        ...
                                        Item {
                                            ...
                                            Row {
                                                ...
                                                Text {
                                                    ...
                                                    font.family: "SF Pro Text"; font.pixelSize: root.s(10)
                                                    color: root.subtext0
                                                }
                                                Text {
                                ...
                                ColumnLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        Behavior on border.color { ColorAnimation { duration: 150 } }
                                        Text {
                                            anchors.centerIn: parent; font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: root.s(11)
                                    ...
                                    RowLayout {
                                        ...
                                        Rectangle {
                                            ...
                                            RowLayout {
                                                ...
                                                Text {
                                                    text: "Delete"; font.family: "SF Pro Text"; font.pixelSize: root.s(10); font.weight: Font.Medium
                                                    color: delMa.containsMouse ? root.base : root.red
                                                    Behavior on color { ColorAnimation { duration: 180 } }
                                                }
                                            }
                                        ...
                                        Rectangle {
                                            ...
                                            RowLayout {
                                                ...
                                                Text {
                                                    text: "Save"; font.family: "SF Pro Text"; font.pixelSize: root.s(10); font.weight: Font.Medium
                                                    color: rowSaveMa.containsMouse ? root.base : root.green
                                                    Behavior on color { ColorAnimation { duration: 180 } }
                                                }
                                            }
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        TextInput {
                            ...
                            font.family: "SF Pro Text"; font.pixelSize: root.s(12); color: root.text; clip: true; selectByMouse: true
                            Text {
                        ...
                        ColumnLayout {
                            ...
                            Item {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { Layout.alignment: Qt.AlignHCenter; text: "Type to search settings & keybinds..."; font.family: "SF Pro Text"; font.pixelSize: root.s(12); color: Qt.alpha(root.subtext0, 0.35) }
                                }
                            }
                                        ...
                                        RowLayout {
                                            ...
                                            ColumnLayout {
                                                ...
                                                Row {
                                                    ...
                                                    Text {
                                                        text: "+"; font.family: "SF Pro Text"; font.pixelSize: root.s(9)
                                                        color: root.overlay0
                                        ...
                                        Rectangle {
                                            ...
                                            RowLayout {
                                                ...
                                                TextInput {
                                                    id: cmdInputFocus
                                                    Layout.fillWidth: true; Layout.fillHeight: true; verticalAlignment: TextInput.AlignVCenter
                                                    font.family: "SF Pro Text"; font.pixelSize: root.s(10); color: root.text; clip: true; selectByMouse: true
                                                    text: model.command
                                        ...
                                        RowLayout {
                                            ...
                                            Rectangle {
                                                ...
                                                RowLayout {
                                                    ...
                                                    Text { text: "Delete"; font.family: "SF Pro Text"; font.pixelSize: root.s(10); color: startupDelMa.containsMouse ? root.base : root.red; Behavior on color { ColorAnimation { duration: 150 } } }
                                                }
                            ...
                            Rectangle {
                                ...
                                Item {
                                    ...
                                    ColumnLayout {
                                        ...
                                        Text { Layout.alignment: Qt.AlignHCenter; font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: root.s(13); color: root.text; text: Config.monitorsModel.count > 0 ? Config.monitorsModel.get(0).name : "—" }
                                        Text { Layout.alignment: Qt.AlignHCenter; font.family: "SF Pro Text"; font.pixelSize: root.s(11); color: root.subtext0; text: root.monCurrentSimW + "\xd7" + root.monCurrentSimH + " @ " + (Config.monitorsModel.count > 0 ? Config.monitorsModel.get(0).rate : "60") + "Hz" }
                                    }
                                }
                            }
                        }
                                ...
                                Rectangle {
                                    ...
                                    Item {
                                        ...
                                        ColumnLayout {
                                            ...
                                            Text { Layout.alignment: Qt.AlignHCenter; font.family: "SF Pro Text"; font.weight: Font.Black; font.pixelSize: root.s(10); color: root.text; text: model.name }
                                            Text { Layout.alignment: Qt.AlignHCenter; font.family: "SF Pro Text"; font.pixelSize: root.s(9); color: root.subtext0; text: model.resW + "\xd7" + model.resH + "@" + model.rate }
                                        }
                                    }
                                }
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                Text {
                                    font.family: "SF Pro Text"; font.weight: isSel ? Font.Black : Font.Bold; font.pixelSize: root.s(13)
                            ...
                            Repeater {
                                ...
                                Item {
                                    ...
                                    Text {
                                        ...
                                        font.family: "SF Pro Text"; font.pixelSize: root.s(8)
