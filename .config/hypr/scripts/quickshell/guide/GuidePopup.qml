                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Text { text: "Update Available"; font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: root.s(12); color: root.green }
                        }
        ...
        Item {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    RowLayout { 
                                        ...
                                        Text { text: root.sysOS; font.family: "SF Mono"; font.weight: Font.Medium; font.pixelSize: root.s(12); color: root.subtext0 } 
                                    }
                                    RowLayout { 
                                        spacing: root.s(6)
                                        Text { text: ""; font.family: "Iosevka Nerd Font"; font.pixelSize: root.s(16); color: root.peach } 
                                        Text { text: root.sysKernel; font.family: "SF Mono"; font.weight: Font.Medium; font.pixelSize: root.s(12); color: root.subtext0 } 
                                    }
                                }
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                RowLayout { 
                                    ...
                                    Text { text: modelData.name; font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: root.s(13); color: root.text } 
                                }
                            ...
                            Rectangle {
                                ...
                                Item {
                                    ...
                                    Column { 
                                        ...
                                        anchors.verticalCenter: parent.verticalCenter
                                        spacing: root.s(2)
                                        Text { text: model.pkg; font.family: "SF Mono"; font.weight: Font.Bold; font.pixelSize: root.s(14); color: root.text } 
                                        Text { text: model.role; font.family: "SF Pro Text"; font.pixelSize: root.s(11); color: root.subtext0 } 
                                    }
                                }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            Layout.fillWidth: true
                            spacing: root.s(4)
                            Text { text: "Interactive Modules"; font.family: "SF Pro Display"; font.weight: Font.Black; font.pixelSize: root.s(28); color: root.text }
                            Text { text: "Use arrow keys or select below to preview. Double-click or press Enter to toggle."; font.family: "SF Pro Text"; font.pixelSize: root.s(13); color: root.subtext0 }
                        }
                        ...
                        Rectangle {
                            ...
                            RowLayout { 
                                ...
                                Text { text: "PLAY"; font.family: "SF Pro Text"; font.weight: Font.Black; font.pixelSize: root.s(14); color: root.base } 
                            }
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    Text { text: "Theming Engine"; font.family: "SF Pro Display"; font.weight: Font.Black; font.pixelSize: root.s(28); color: root.text; Layout.alignment: Qt.AlignVCenter }
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            ColumnLayout { 
                                ...
                                Text { text: "Wallpaper"; font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: root.s(12); color: root.text; Layout.alignment: Qt.AlignHCenter } 
                            }
                            ...
                            Rectangle {
                                ...
                                ColumnLayout { 
                                    anchors.centerIn: parent
                                    spacing: root.s(8)
                                    Text { text: "Matugen Core"; font.family: "SF Pro Text"; font.weight: Font.Black; font.pixelSize: root.s(15); color: root.ambientPurple; Layout.alignment: Qt.AlignHCenter } 
                                    RowLayout { 
                                        spacing: root.s(4)
                                        Layout.alignment: Qt.AlignHCenter
                                        Repeater { 
                            ...
                            ColumnLayout { 
                                ...
                                Text { text: "Templates"; font.family: "SF Pro Text"; font.weight: Font.Bold; font.pixelSize: root.s(12); color: root.text; Layout.alignment: Qt.AlignHCenter } 
                            }
                            Item { Layout.fillWidth: true } 
                        }
                    }

                    Text { text: "When you change wallpapers, Matugen extracts the dominant colors and injects them directly into these configuration files in real-time:"; font.family: "SF Pro Text"; font.pixelSize: root.s(13); color: root.subtext0; Layout.fillWidth: true; wrapMode: Text.WordWrap; Layout.alignment: Qt.AlignVCenter }
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                RowLayout { 
                                    ...
                                    Text { text: modelData.f; font.family: "SF Mono"; font.weight: Font.Medium; font.pixelSize: root.s(12); color: root.text; Layout.fillWidth: true; Layout.alignment: Qt.AlignVCenter } 
                                }
